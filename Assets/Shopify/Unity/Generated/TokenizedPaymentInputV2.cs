namespace Shopify.Unity {
    ...
    public class TokenizedPaymentInputV2 : InputBase {
        ...
        /// Public Hash Key used for AndroidPay payments only.
        /// </param>
        public TokenizedPaymentInputV2(MoneyInput paymentAmount,string idempotencyKey,MailingAddressInput billingAddress,string type,string paymentData,bool? test = null,string identifier = null) {
